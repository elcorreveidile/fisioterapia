...
async function seed() {
  ...
  const [
    ...
    .values([
      {
        title: 'Estiramientos de cervicales',
      ...
      {
        title: 'Contracción de suelo pélvico',
      ...
      {
        title: 'Press de hombro con banda',
